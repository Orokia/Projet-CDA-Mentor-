 ...
 */
final class Version20260821161225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formateur ADD image LONGTEXT NOT NULL, DROP photo');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formateur ADD photo VARCHAR(255) NOT NULL, DROP image');
