 ...
 */
final class Version20260905230047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE disponibilite ADD date_fin DATE NOT NULL, ADD jours_semaine JSON NOT NULL, DROP statut, CHANGE formateur_id formateur_id INT NOT NULL, CHANGE date date_debut DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE disponibilite ADD date DATE NOT NULL, ADD statut VARCHAR(255) DEFAULT NULL, DROP date_debut, DROP date_fin, DROP jours_semaine, CHANGE formateur_id formateur_id INT DEFAULT NULL');
