 ...
 */
final class Version20260904083337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE disponibilite ADD formation_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_2CBACE2F5200282E ON disponibilite (formation_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2CBACE2F5200282E ON disponibilite');
        $this->addSql('ALTER TABLE disponibilite DROP formation_id');
