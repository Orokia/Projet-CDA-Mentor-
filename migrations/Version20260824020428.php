 ...
 */
final class Version20260824020428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formateur CHANGE password password VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formateur CHANGE password password VARCHAR(255) NOT NULL');
