 ...
 */
final class Version20260823214941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formateur ADD email VARCHAR(180) NOT NULL, ADD password VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE user DROP INDEX IDX_8D93D649155D8F51, ADD UNIQUE INDEX UNIQ_8D93D649155D8F51 (formateur_id)');
        $this->addSql('ALTER TABLE user DROP INDEX IDX_8D93D649CB944F1A, ADD UNIQUE INDEX UNIQ_8D93D649CB944F1A (student_id)');
        $this->addSql('ALTER TABLE user CHANGE photo_utilisateur photo_utilisateur LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formateur DROP email, DROP password');
        ...
        $this->addSql('ALTER TABLE `user` DROP INDEX UNIQ_8D93D649CB944F1A, ADD INDEX IDX_8D93D649CB944F1A (student_id)');
        $this->addSql('ALTER TABLE `user` DROP INDEX UNIQ_8D93D649155D8F51, ADD INDEX IDX_8D93D649155D8F51 (formateur_id)');
        ...
        $this->addSql('ALTER TABLE `user` CHANGE photo_utilisateur photo_utilisateur VARCHAR(255) DEFAULT NULL');
    }
}
